...
// Prepare the query to fetch active rescuers (those who have taken at least one request or offer) and what they carry
$sql = "SELECT r.username, r.name, r.surname, r.phone, r.latitude, r.longitude,
        ...
        FROM rescuers r
        JOIN rescuer_tasks rt ON r.username = rt.rescuerUsername
        LEFT JOIN onvehicles ov ON r.username = ov.rescuerUsername
        WHERE rt.taskType IN ('request', 'offer')
        GROUP BY r.username";
